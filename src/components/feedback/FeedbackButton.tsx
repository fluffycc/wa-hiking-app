  ...
  return (
    <>
      <button
        ...
        className="fixed bottom-20 right-4 z-50 bg-trail-dark text-white font-body font-medium text-sm rounded-full px-4 py-2.5 shadow-lg hover:bg-trail-green transition-colors flex items-center gap-1.5"
      >
        💬 Feedback
      </button>
