...
const CORRECTIONS: TrailCorrection[] = [
  {
    aliases: ['rainbow town', 'rainbow town trail', 'red town meadow', 'red town meadow trails', 'red town trail'],
    maxDistanceDeg: 0.25,
    values: {
      name: 'Rainbow Town Trail',
      region: 'Snoqualmie Region',
      lat: 47.5348333333,
      lng: -122.1288,
      miles: 1.5,
      elevationGainFt: 150,
      trailheadElevationFt: 650,
      difficulty: 'Easy',
      routeType: 'Loop',
      landOwner: 'County',
      parking: {
      ...
      wta: {
        ...
        url: 'https://www.wta.org/go-hiking/hikes/redtown-meadow',
        syncedAt: NOW,
        statsSyncedAt: NOW,
        status: 'matched',
        statsAvailable: true,
